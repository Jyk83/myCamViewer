@echo off
REM Phase10 RealtimeITagControl Build Script

echo ====================================
echo Phase10 RealtimeITagControl 빌드
echo ====================================
echo.
...
REM 솔루션 빌드 (Release, x86)
echo [2/3] 솔루션 빌드 (Release)...
...
REM Siemens.Runtime.ControlDev.dll 복사
echo [3/3] DLL 복사...
