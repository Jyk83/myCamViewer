...
namespace RealtimeITagControl.Trace
{
    ...
    public class CuttingProgressManager
    {
        ...
        /// Phase 14: partIndex and contourIndex are already 0-based, no conversion needed
        /// </summary>
        public bool UpdateProgress(int partIndex, int contourIndex, int elementIndex, double progress)
        {
            ...
            // Phase 14 FIX: Already 0-based indices from caller
            int partIdx = partIndex;
            int contourIdx = contourIndex;
